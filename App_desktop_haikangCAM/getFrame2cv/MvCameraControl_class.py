...
from ctypes import *
try :
    from getFrame2cv.CameraParams_const import *
    from getFrame2cv.CameraParams_header import *
    from getFrame2cv.MvCameraControl_header import *
    from getFrame2cv.MvErrorDefine_const import *
    from getFrame2cv.PixelType_const import *
    from getFrame2cv.PixelType_header import *
except:
